// OrderWizard.Module.Address.Shipping.RetailLoggedIn.js
// --------------------------------------
// 
define('OrderWizard.Module.Address.Shipping.RetailLoggedIn', ['OrderWizard.Module.Address.RetailLoggedIn'],  function (OrderWizardModuleAddress)
{
	'use strict';
	...
	,	sameAsMessage: _('Check if same as Billing Address').translate()
